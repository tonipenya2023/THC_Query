...
$logFile = $logDir . DIRECTORY_SEPARATOR . 'import_users_trophies_errors.log';
...
foreach ($users as $user) {
    ...
    try {
        ...
        $trophiesImported += $count;
        fwrite(STDOUT, "[OK] {$count} trofeos\n");
    } catch (Throwable $e) {
        $usersWithErrors++;
...
fwrite(STDOUT, "Trofeos importados: {$trophiesImported}\n");
